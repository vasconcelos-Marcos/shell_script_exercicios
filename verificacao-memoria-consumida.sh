...
if [ $porcentagem -gt 80 ]
then
mail -s "Consumo de memoria acima do limite" vasconcelmarcos@gmail.com<<del
O consumo de memoria esta acima do limite de 80% que foi especificado. Atualmente o consumo e de: $memoria_consumida_h/$memoria_total_h.
del
fi
